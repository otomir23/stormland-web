                ...
                {profiles
                    ...
                    .map(u => (
                        <Link
                            href={`/profile/${u.uuid}`}
                            key={u.uuid}
                            className="flex items-center gap-4 rounded-lg border border-neutral-300 px-6 py-4 text-lg
                            transition-colors duration-300 ease-in-out hover:border-red-500"
                        >
                            <div className="relative">
                                ...
                                {u.online && (
                                    <div
                                        className="absolute -bottom-1.5 -right-1.5 h-4 w-4 rounded-full border-2
